...
| 论文模型 metadata/曲线产物框架 | 已提取 Song et al. 2025 模型参数，并能从数字化 CSV 写出 `paper_response_overlay.png`, `paper_relative_error_curves.png`, `runtime_diagnostics.json` | 真实曲线仍需数字化或获得表格数据 |
